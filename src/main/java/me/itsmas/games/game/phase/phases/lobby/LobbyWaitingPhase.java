package me.itsmas.games.game.phase.phases.lobby;
...
/**
 * The phase of a games where players are waiting in the lobby before the countdown
 */
public class LobbyWaitingPhase extends LobbyPhase
{
    /**
     * The minimum needed amount of players for the games
     */
