package me.itsmas.game.game.team;
...
public abstract class TeamGame extends Game
{
    ...
    public TeamGame(GameManager manager, GameType type, int teamSize, Team... teams)
    {
        ...
        this.scoreboard.getTeams().forEach(team -> team.getEntries().forEach(team::removeEntry));
    }
    ...
    private void initTeam(Team team)
    {
        ...
        scTeam.setPrefix(team.getColour().toString());
